...
import { getProformaInvoicesAction, getSignedEmployeeProformaInvoicesAction, updateProformaInvoiceStatus } from '../../../actions/proformaInvoice';
      ...
      proformaInvoices.map((proformaInvoice, index) => (
        <tr key={index}>
          ...
          <td>{proformaInvoice.buyer_address}</td>        
            <td>
            <DownloadPDFButton pi_id={proformaInvoice.pi_id} pdfName={`signed_${proformaInvoice.pi_no}_${proformaInvoice.employee}_${proformaInvoice.manager}_${proformaInvoice.pi_id}`}/>
             </td>
             <td>
