...
const PackingList = () => {
  ...
  const handleSearchPi = async () => {
    ...
    await axios
      .get(`${BASE_URL}/packinglist/info/${piNumber}`)
      .then(async (response) => {
            ...
            <div>
              <div style={{ display: "flex" }}>
                ...
                <div className="info_row">
                  ...
                  <div className="">
                    <input type="text" value={customer} onChange={(e) => setCustomer(e.target.value)} autocomplete="on">
                      {" "}
                    </input>
                  </div>
                </div>
              ...
              {Array.from({ length: truckItems.length }, (truck, index) => (
                <div key={index} className="truck">
                  ...
                  <div className="info_row">
                    ...
                    <div className="">
                      <input type="text" value={truckItems[index].truckNo} onChange={(event) => handleTruckInputChange(event, index, "truckNo")} autocomplete="on"></input>
                    </div>
                  </div>{" "}
                  <div className="info_row">
                          ...
                          <div className="warehouses">
                            {product.bookedWarehouses.map((warehouse, whIndex) => (
                              <div className="warehouse_bl_item" style={{ flex: 1 }} key={whIndex}>
                                <div className="warehouse_bl_item_code">{warehouse.qty - getTotalProductQtyInWarehouse(product.productId, warehouse.warehouse)}</div>{" "}
              ...
              {truckItems.map((truckItem, index) => (
                <div className="truck" key={index}>
                  ...
                  <div className="info_row">
                    <div className="label_div">BL : </div>
                    <div style={{ width: "100%" }}>
                      <input type="text" value={truckItems[index].truckBls} onChange={(event) => handleTruckInputChange(event, index, "truckBls")} autocomplete="on"></input>
                    </div>
                  </div>{" "}
                </div>
              ))}
