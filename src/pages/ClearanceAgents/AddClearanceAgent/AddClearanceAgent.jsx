...
const AddClearanceAgent = () => {
  ...
  const handleSubmit = () => {
    ...
    console.log(model);
    axios
      .post(`${BASE_URL}/clearance-agent`, model)
      .then((response) => {
        // console.log(response.data);
        showToastMessage("Clearance Agent Added Successfully", "success");
        resetFrom(false);
        setServices([]);
        setContacts([]);
...
export default AddClearanceAgent;
