...
import "./UpdateClearanceAgent.scss";
...
const UpdateClearanceAgent = () => {
  ...
  const handleSubmit = () => {
    ...
    console.log(model);
    axios
      .put(`${BASE_URL}/clearance-agent/${state._id}`, model)
      .then((response) => {
        // console.log(response.data);
        showToastMessage("Clearance  Updated Successfully", "success");
        navigate("/user/clearanceAgents");
      })
      .catch((error) => {
        // Handle any errors
        console.error(error);
        ...
        <div className="card">
          <div class="card-header">
            <div class="tittle-card tittle-back">
              <div className="btn-back" onClick={() => navigate("/user/clearanceAgents")}>
                <i class="uil uil-arrow-circle-left"></i>
              </div>
              <p> Update Clearance Agent </p>
            </div>
          </div>
                  ...
                  <div className="col-lg-4 col-md-12">
                    <div className="form-group">
                      <label htmlFor="forwarder_name">
                        Clearance Agent Name <span className="required">*</span>
                      </label>
...
export default UpdateClearanceAgent;
