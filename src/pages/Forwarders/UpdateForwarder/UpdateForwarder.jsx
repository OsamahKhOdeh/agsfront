...
import "../AddForwarder/AddForwarder.scss";
...
const UpdateForwarder = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    costPerContainer: state.costPerContainer,
    communicationMethod: state.communicationMethod,
    services: state.services,
    freeStorageDuration: state.freeStorageDuration,
    availableContainerCount: state.availableContainerCount,
    notes: state.notes,
  });
