        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="form-group">
              ...
              <input class="form-control" id="final_distenation" type="text" name="final_distination" value={inputs.final_distination || ""} onChange={handleChange} autocomplete="on"/>
            </div>
          </div>
          <div className="col-lg-6 col-md-12">
            <div className="form-group">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="form-group">
              ...
              <input class="form-control" type="text" id="paymentPercentage" name="paymentPercentage" value={inputs.paymentPercentage || ""} onChange={handleChange} autocomplete="on"/>
            </div>
          </div>
          <div className="col-lg-6 col-md-12">
            <div className="form-group">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div className="modal-data-summary">
                <div className="form-group">
                  <strong>Total: </strong>
                  <span> {total.toFixed(3)} {inputs.currency}</span> 
                </div>
                <div className="form-group">
                  <strong>Discount: </strong>
                  <span> {inputs.discount} {inputs.currency}</span> 
                </div>
                <div className="form-group">
                  <strong>Additions: </strong>
                  <span> {inputs.additions} {inputs.currency}</span> 
                </div>
                <div className="form-group">
                  <strong>Final: </strong>
                  <span> {total.toFixed(3) - -inputs.additions - inputs.discount} {inputs.currency}</span> 
                </div>
              </div>
            </div>
