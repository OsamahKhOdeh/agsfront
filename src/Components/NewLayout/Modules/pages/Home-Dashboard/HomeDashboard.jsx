...
export const HomeDashboard = () => {
  ...
  const routeToCustomerManagment = () => {};
  return (
    <ul className="grid">
      ...
      <li className="grid-item">
        ...
        <div className="item-body" onClick={() => navigate("/customerManagment")}>
      ...
      <li className="grid-item">
        ...
        <div className="item-body" onClick={() => navigate("/blogs")}>
          <table class="table  ">
            <tbody>
              <tr>
      ...
      <li className="grid-item">
        ...
        <div className="item-body" onClick={() => navigate("/report")}>
          <table class="table  ">
            <tbody>
              <tr>
