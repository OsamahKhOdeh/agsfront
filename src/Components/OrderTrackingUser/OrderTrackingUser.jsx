          ...
          <tbody>
            {proformaInvoices.map((proformaInvoice, index) => (
              ...
              >
                ...
                <td>
                  <div className="td_padding employee_cell">
                    {proformaInvoice.employee}
                  </div>
                </td>
                {/* <td>
                    {" "}
                ...
                <td>
                  <div className="td_padding customer_cell">
                ...
                <td className="next-previous-btns">
                  ...
                  <i
                    class="uil uil-arrow-right next-btn"
                    onClick={() => handlStatusOrder(true, proformaInvoice._id)}
                  ></i>
                  </button>
                 <button disabled={proformaInvoice.processStatus.length <= 1}>
                  <i
                    class="uil uil-arrow-left previous-btn"
                    onClick={() => handlStatusOrder(false, proformaInvoice._id)}
                  ></i>
                  </button>
                </td>
                <td>
